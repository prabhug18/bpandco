...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if ($productionRole) {
            ...
            // 3. Clear and update Daily Scoring Tiers for Production Role
            DailyScoringTier::whereIn('metric_id', [$boxMetric->id, $mixingMetric->id, $stockMetric->id])
                ->where('role_id', $roleId)
                ->delete();
            ...
            // 4. Clear and update Period Targets for Production Role
            PeriodTarget::whereIn('metric_id', array_filter([
                $boxMetric->id,
                $mixingMetric->id,
                $stockMetric->id,
                $attMetric?->id,
